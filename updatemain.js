  ...
  .then((usersContents)=>{
    ...
    if(userDatas===undefined){
      ...
      if(passWord===passWord1){
        // here i am calling the checkpassword function for checking the password
        passwordValue=checkpassword(passWord)
        if(passwordValue===true){
          ...
          console.log("password length shold greater than 8 and one special chrecter and any number")
        }
      }
      else{
...
// this is for login 
  ...
  .then((uData)=>{
    ...
    // if user is exits will check for password,passwordvalidation.
      ...
      passwordValidation=checkpassword(Upassword)
      if(Upassword===confirmPassword){
        if(passwordValidation===true){
          ...
          console.log("password should contain special character,number, and length shold be 8")
        }
      }
      else{
